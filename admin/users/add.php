<?php
/**
 * Users Management Module - Add User Page
 */
session_start();
...
<head>
    ...
    <title>Add New User · ID Card Generator</title>
...
<body>
                    ...
                    <div class="col-lg-8 col-md-10">
                        <div class="card">
                            ...
                            <div class="card-body-custom">
                                <form action="save.php" method="post" enctype="multipart/form-data" novalidate>
                                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars(generate_csrf_token()) ?>">

                                    <!-- Avatar Preview & Upload -->
                                    <div class="avatar-upload-container">
                                        <div class="avatar-preview-box">
                                            <img src="../../images/avatars/default.png" id="avatarPreview" alt="Avatar Preview">
                                        </div>
                                        <div class="text-center">
                                            ...
                                            <div class="form-text small">Allowed: JPG, PNG, WEBP (Max 2MB)</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="full_name" id="full_name" class="form-control" placeholder="e.g. John Doe" value="<?= htmlspecialchars($oldData['full_name'] ?? '') ?>" required autofocus>
                                        </div>

                                        <!-- Username -->
                                        <div class="col-md-6">
                                            <label for="username" class="form-label">Username <span class="text-danger">*</span></label>
                                            <input type="text" name="username" id="username" class="form-control" placeholder="e.g. johndoe" value="<?= htmlspecialchars($oldData['username'] ?? '') ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control" placeholder="e.g. john@example.com" value="<?= htmlspecialchars($oldData['email'] ?? '') ?>">
                                        </div>

                                        <!-- Mobile -->
                                        <div class="col-md-6">
                                            <label for="mobile" class="form-label">Mobile Number</label>
                                            <input type="text" name="mobile" id="mobile" class="form-control" placeholder="e.g. +1987654321" value="<?= htmlspecialchars($oldData['mobile'] ?? '') ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="organization_id" id="organization_id" class="form-select" <?= !is_super_admin($currentUser) ? 'readonly' : '' ?>>
                                                ...
                                                <?php foreach ($scopedOrgs as $org): ?>
                                                    <option value="<?= (int)$org['id'] ?>" <?= ($oldData['organization_id'] ?? (string)($currentUser['organization_id'] ?? '')) == (string)$org['id'] ? 'selected' : '' ?>>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="role_id" id="role_id" class="form-select" required>
                                                ...
                                                <?php foreach ($scopedRoles as $r): ?>
                                                    <option value="<?= (int)$r['id'] ?>" <?= ($oldData['role_id'] ?? '') == (string)$r['id'] ? 'selected' : '' ?>>
    ...
    <script>
        ...
        // Generate unique username suggestion from full name
