<?php
/**
 * Role Management Module - Edit Role Page
 */
session_start();
...
$roleName = $oldData['role_name'] ?? $role['role_name'];
$description = $oldData['description'] ?? $role['description'];
$status = $oldData['status'] ?? (string)$role['status'];
...
<head>
    ...
    <title>Edit Role · ID Card Generator</title>
                    ...
                    <div class="col-lg-7 col-md-9">
                        <div class="card">
                            <div class="card-header-custom">
                                <h5><i class="fas fa-edit"></i> Edit Role: <?= htmlspecialchars($role['role_name']) ?></h5>
                                <span class="badge-custom">ID: #<?= (int)$role['id'] ?></span>
                            </div>
                            <div class="card-body-custom">
                                <form action="update.php" method="post" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="role_name" id="role_name" class="form-control form-control-lg <?= isset($errors['role_name']) ? 'is-invalid' : '' ?>" value="<?= htmlspecialchars($roleName) ?>" required autofocus>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description" class="form-control" rows="4" placeholder="Brief explanation of the responsibilities and scope of this role..."><?= htmlspecialchars($description) ?></textarea>
                                    ...
                                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                                        ...
                                        <div class="d-flex flex-column flex-md-row gap-2 w-100 w-md-auto">
                                            <a href="permissions.php?id=<?= (int)$role['id'] ?>" class="btn btn-outline-warning">
